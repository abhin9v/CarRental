...
// function to check availability of the car for a given date 
...
// API to check car availability of car for the given date and location
...
export const checkAvailabilityOfCar = async (req,res) => {
    ...
    try {
        ...
        // check car availabilty using promise
